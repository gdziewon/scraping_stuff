...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    # Just to make sure we have access to settings
    @classmethod
    def from_crawler(cls, crawler):
        return cls(crawler.settings)

    # Getting settings for setting.py file
    ...
    def _get_user_agents_list(self):
        ...
        # Getting user-agents from scrapeops
    ...
    # Checking if user-agent is active or inactive
    ...
    # Sets header user-agent to random user-agent from the list
    def process_request(self, request, spider):
